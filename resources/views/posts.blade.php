      ...
      <div class="col-md-4">
        <article class="card post-card">
          ...
          <section class="card-body">
            ...
            <h6 class="card-subtitle mb-2 text-muted">Written by {{ title_case('Casper Engelmann') }}</h6>
            <p class="card-text">{{ str_limit(strip_tags(Lipsum::short()->text(3)), 150, '...') }}</p>
            <a href="/message/1" class="card-link">Contact Scout</a>
            <a href="#!" class="card-link" data-toggle="modal" data-target="#post-1">Read more</a>
          </section>
        </article>

        <div class="modal" id="post-1">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <h5 class="mb-2 text-muted">Written by {{ title_case('Casper Engelmann') }}</h5>

                <?php echo Lipsum::short()->text(3); ?>
              ...
              <div class="modal-footer">
                <a href="/message/1" class="btn btn-primary">Contact Scout</a>
