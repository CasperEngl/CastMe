...
<section class="row">
  ...
  <div class="col-12 col-sm-6 col-lg-4 animated fadeInRight delay-1000ms">
    <a href="{{ route('post.new') }}" class="btn tile">
      <i class="fas fa-plus"></i><span class="d-inline-block">{{ title_case(__('new post')) }}</span>
    </a>
  </div>
  <div class="col-12 col-sm-6 col-lg-4 animated fadeInRight delay-1200ms">
...
<section class="row">
  ...
  <div class="col-12 col-sm-6 col-lg-4 animated fadeInRight delay-1400ms">
