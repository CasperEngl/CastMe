              ...
              <div class="row">
                ...
                <div class="col-12 col-sm">
                  <div class="form-group">
                    ...
                    <small class="form-text text-muted">{{ title_case(__('Height must be in centimeters.')) }}</small>
                  </div>
                </div>
                <div class="col-12 col-sm">
                  <div class="form-group">
                    ...
                    <small class="form-text text-muted">{{ title_case(__('We only support weight in kilos.')) }}</small>
                  </div>
                </div>
                <div class="col-12 col-sm">
                  <div class="form-group">
                    ...
                    <small class="form-text text-muted">{{ title_case(__('Experience is in whole years to keep it simple.')) }}</small>
                  </div>
                </div>
              </div>
