                  ...
                  <div class="form-group">
                    ...
                    <ul class="pagination">
                      <div class="display-none">
                        <input type="radio" name="hair_color" value="1" id="hair-black"> Black
                        <input type="radio" name="hair_color" value="2" id="hair-brown" checked> Brown
                        <input type="radio" name="hair_color" value="3" id="hair-blond"> Blond
                        <input type="radio" name="hair_color" value="4" id="hair-auburn"> Auburn
                        <input type="radio" name="hair_color" value="5" id="hair-red"> Red
                        <input type="radio" name="hair_color" value="6" id="hair-white"> Gray or white
                      </div>
                      <li class="page-item">
